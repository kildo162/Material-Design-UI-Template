...
public class TabMediaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.toolbar_tab_media);
        toolbar.setTitle("Tabs media");
        setSupportActionBar(toolbar);
        tabs = (PagerSlidingTabStrip) findViewById(R.id.activity_tab_media_tabs);
        pager = (ViewPager) findViewById(R.id.activity_tab_media_pager);
        ...
        tabs.setOnTabReselectedListener(new PagerSlidingTabStrip.OnTabReselectedListener() {
            ...
            public void onTabReselected(int position) {
                Toast.makeText(TabMediaActivity.this, "Tab reselected: " + position, Toast.LENGTH_SHORT).show();
            }
        });
    }
