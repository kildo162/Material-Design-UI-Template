...
public class TabUniversalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_universal);
        ...
        tabs.setOnTabReselectedListener(new PagerSlidingTabStrip.OnTabReselectedListener() {
            ...
            public void onTabReselected(int position) {
                Toast.makeText(TabUniversalActivity.this, "Tab reselected: " + position, Toast.LENGTH_SHORT).show();
            }
        });
    }
