...
public class DummyContent {
	...
	public static ArrayList<DummyModel> getDummyModelGoogleCardsTravelList() {
		...
		list.add(new DummyModel(0, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/0.jpg", "Monument walk tour", R.string.fontello_heart_empty));
		...
		list.add(new DummyModel(2, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/2.jpg", "Fall in Prague", R.string.fontello_heart_empty));
		list.add(new DummyModel(3, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/3.jpg", "San Francisco tour", R.string.fontello_heart_empty));
		list.add(new DummyModel(4, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/4.jpg", "Geyser on Island", R.string.fontello_heart_empty));
		list.add(new DummyModel(5, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/5.jpg", "Old house tour", R.string.fontello_heart_empty));
		list.add(new DummyModel(6, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/6.jpg", "Hitchhike", R.string.fontello_heart_empty));
		list.add(new DummyModel(7, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/7.jpg", "Beach walk tour", R.string.fontello_heart_empty));
	...
	public static ArrayList<DummyModel> getDrawerShopDummyList() {
		ArrayList<DummyModel> list = new ArrayList<>();
		list.add(new DummyModel(0, "", "Categories", R.string.material_icon_headline));
		list.add(new DummyModel(1, "", "Discounts", R.string.material_icon_dollar));
		list.add(new DummyModel(2, "", "My cart", R.string.material_icon_cart));
		list.add(new DummyModel(3, "", "My wishlist", R.string.material_icon_star));
		list.add(new DummyModel(4, "", "My Account", R.string.material_icon_account));
		list.add(new DummyModel(4, "", "Settings", R.string.material_icon_settings));
		return list;
	}
	...
	public static ArrayList<DummyModel> getDrawerMediaDummyList() {
		ArrayList<DummyModel> list = new ArrayList<>();
		list.add(new DummyModel(0, "", "Albums", R.string.material_icon_headphones));
		list.add(new DummyModel(1, "", "Artist", R.string.material_icon_human));
		list.add(new DummyModel(2, "", "Playlist", R.string.material_icon_headline));
		list.add(new DummyModel(3, "", "Stream", R.string.material_icon_soundcloud));
