...
public class ParallaxMediaAdapter extends BaseAdapter implements Swappable,
		OnClickListener {
	...
	public ParallaxMediaAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.favorite = (TextView) convertView.findViewById(R.id.list_item_parallax_travel_icon_favorite);
			holder.comment = (TextView) convertView.findViewById(R.id.list_item_parallax_travel_icon_comment);
			holder.share = (TextView) convertView.findViewById(R.id.list_item_parallax_travel_icon_share);
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.list_item_parallax_travel_icon_favorite:
			Toast.makeText(mContext, "Favorite: " + position, Toast.LENGTH_SHORT)
					.show();
			break;
		case R.id.list_item_parallax_travel_icon_comment:
			Toast.makeText(mContext, "Comment: " + position, Toast.LENGTH_SHORT)
					.show();
			break;
		case R.id.list_item_parallax_travel_icon_share:
